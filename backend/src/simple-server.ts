...
const tokens: { [token: string]: string } = {}; // token -> userId
...
app.post('/api/portfolio/trade', authenticate, (req: any, res) => {
  ...
  // Enforce: Do not allow SELL at a higher rate than market price
