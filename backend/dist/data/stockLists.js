...
exports.STOCK_LIST_INFO = exports.NIFTY_500_ADDITIONAL = exports.SENSEX_30 = exports.NIFTY_50 = void 0;
exports.getAllNifty50 = getAllNifty50;
exports.getAllSensex30 = getAllSensex30;
exports.getAllNifty500 = getAllNifty500;
exports.getStocksByMarketCap = getStocksByMarketCap;
exports.getStocksBySector = getStocksBySector;
...
function getAllNifty50() {
    return exports.NIFTY_50;
}
function getAllSensex30() {
    return exports.SENSEX_30;
}
function getAllNifty500() {
    return [...exports.NIFTY_50, ...exports.NIFTY_500_ADDITIONAL];
}
function getStocksByMarketCap(marketCap) {
...
function getTopNStocks(n, list = 'nifty50') {
    let stockList;
    switch (list) {
        case 'sensex30':
